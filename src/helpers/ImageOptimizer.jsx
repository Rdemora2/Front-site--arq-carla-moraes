...
const Placeholder = styled.div`
  ...
  background: ${(props) =>
    props.bgGradient || "linear-gradient(45deg, #f0f0f0, #e0e0e0)"};
    ...
    const generateSrcSet = useCallback(
      (originalSrc) => {
        ...
        return sizes
          .map((size) => {
            const ext =
              extensions.find((e) => originalSrc.includes(e)) || "jpg";
      ...
      >
        ...
        {currentSrc && !error && (
          <StyledImage
            src={
              isLowQuality
                ? optimizeImageUrl(currentSrc, { quality: 20 })
                : optimizeImageUrl(currentSrc)
            }
            alt={alt}
            width={width}
            height={height}
