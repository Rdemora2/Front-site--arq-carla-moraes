...
describe("MetaTags", () => {
  ...
  it("deve truncar título longo", () => {
    const longTitle =
      "Este é um título muito longo que deve ser truncado automaticamente pelo componente para não passar de 60 caracteres";
  ...
  it("deve truncar descrição longa", () => {
    const longDescription =
      "Esta é uma descrição muito longa que deve ser truncada automaticamente pelo componente para não passar de 160 caracteres conforme as boas práticas de SEO recomendadas pelos motores de busca principais como Google e Bing";
