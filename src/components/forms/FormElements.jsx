...
const baseInputStyles = css`
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 3px ${props => props.hasError ? 'rgba(239, 68, 68, 0.1)' : 'rgba(62, 77, 44, 0.1)'};
    transform: translateY(-1px);
  }

  &:hover:not(:focus) {
    border-color: ${props => props.hasError ? '#ef4444' : 'var(--color-secondary)'};
  }
...
const StyledCheckbox = styled.div`
  ...
  background-color: ${props => props.checked ? 'var(--color-primary)' : 'white'};
